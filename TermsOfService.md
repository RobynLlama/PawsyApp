Terms of Service for PawsyApp

Last Updated: June 11, 2026

By adding PawsyApp ("the Bot") to your Discord server or interacting with it, you agree to be bound by these Terms of Service. If you do not agree, please remove the Bot from your server.
1. Eligibility & Compliance

    Discord Terms: You must comply with the official Discord Terms of Service and Community Guidelines at all times when using this Bot.

    Authority: By adding the Bot to a server, you affirm that you have the necessary administrative permissions within that server to do so.

2. Acceptable Use

You agree not to use the Bot to:

- Exploit, reverse-engineer, or intentionally attempt to crash or bypass the Bot's moderation features.
- Use the Bot's logging or moderation output to harass, dox, or abuse other users.
- Spam commands or otherwise maliciously disrupt the Bot’s performance for other servers.
